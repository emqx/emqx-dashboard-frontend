...
<span> Forwarding messages to HTTP Webhook</span>`,
  ...
  client_check_acl_complete: 'client check acl complete',
  client_connack: 'client connack',
  ...
  sqlNoResultDesc: 'SQL returns empty, conditional clause not matched',
  duplicate: 'Duplicate',
...
<span>将消息转发至 HTTP Webhook</span>`,
  ...
  client_check_acl_complete: '鉴权结果',
  client_connack: '连接确认',
  ...
  sqlNoResult: 'SQL 无输出',
  sqlNoResultDesc: 'SQL 返回结果为空，条件子句未匹配',
  duplicate: '复制',
  resetMetrics: '重置度量指标',
...
<span>メッセージをHTTP Webhookへ転送する</span>`,
  ...
  client_check_acl_complete: '認証結果',
  client_connack: '接続確認',
  ...
  sqlNoResultDesc: 'SQL は空を返し、条件句が一致しません',
  duplicate: 'コピー',
