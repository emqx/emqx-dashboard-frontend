...
export default {
  ...
  oper: {
    ...
    warning: 'ワーニング',
    subscribe: 'サブスクリプション',
    unsubscribe: 'アンサブスクリプション',
    unsubscribeConfirm: 'この操作を実行するとアンサブスクリプションになります',
  ...
  plugins: {
    ...
    searchByName: 'プラグイン名で検索してください',
    usernameRequired: 'ユーザー名を入力してください',
    passwordRequired: 'パスワードを入力してください',
    clientidRequired: 'クライアント IDを入力してください',
    algorithm: 'アルゴリズム',
    secret: 'シークレット',
  ...
  users: {
    ...
    authenticate: 'パスワードを変更しました。もう一度ログインしてください',
