...
export default {
  ...
  clients: {
    ...
    recv_msg_qos0: 'QoS 0 消息流入',
    recv_msg_qos1: 'QoS 1 消息流入',
    recv_msg_qos2: 'QoS 2 消息流入',
    recv_msg_dropped: '消息流入丢弃数',
    recv_msg_dropped_expired: '消息流入丢弃数（过期）',
    send_msg_qos0: 'QoS 0 消息流出',
    send_msg_qos1: 'QoS 1 消息流出',
    send_msg_qos2: 'QoS 2 消息流出',
    send_msg_dropped: '消息流出丢弃数',
    send_msg_dropped_expired: '消息流出丢弃数（过期）',
    send_msg_dropped_queue_full: '消息流出丢弃数（队列已满）',
    send_msg_dropped_too_large: '消息流出丢弃数（消息过大）',
    currentSubs: '当前订阅数',
    addSubs: '添加订阅',
    view: '详情',
    disconnected: '已断开',
  ...
  slowSub: {
    slowSub: '慢订阅',
    slowSubDesc:
      '（统计最近时间窗口内 消息传输过慢的订阅者，按照传输时延生成历史记录，需要启用emqx_mod_slow_subs模块. 配置: module.slow_subs.*）',
    latencyTime: '时长',
    updated: '更新时间',
    clearData: '重置数据',
  ...
  logTrace: {
    logTrace: '日志追踪',
    logTraceDesc: '（针对指定 ClientID 或 Topic 或 IP 实时过滤日志，用于调试和排查错误）',
    activeList: '活跃中的Trace列表',
    finishedList: '已完成的Trace列表',
    name: '名称',
    type: '类型',
    condition: '条件',
    startTime: '起始时间',
    ...
    stopSuc: '停止Trace成功',
    deleteSuc: '删除Trace成功',
    tooLargeLog: '日志过长，建议下载后查看',
    confirmDeleteTrace: '确定删除该Trace',
    needStartTime: '请输入起始时间和结束时间',
    needOnePacket: '请选择至少一种',
    loadNextPage: '正在加载更多',
    srunning: '运行中',
    sstopped: '已停止',
    swaiting: '等待中',
