...
export default {
  ...
  clients: {
    ...
    recv_msg_qos0: 'QoS 0 Messages Received',
    recv_msg_qos1: 'QoS 1 Messages Received',
    recv_msg_qos2: 'QoS 2 Messages Received',
    recv_msg_dropped: 'Dropped Messages In',
    recv_msg_dropped_expired: 'Dropped Messages In(Expired)',
    send_msg_qos0: 'QoS 0 Messages Sent',
    send_msg_qos1: 'QoS 1 Messages Sent',
    send_msg_qos2: 'QoS 2 Messages Sent',
    send_msg_dropped: 'Dropped Messages Out',
    send_msg_dropped_expired: 'Dropped Messages Out(Expired)',
    send_msg_dropped_queue_full: 'Dropped Messages Out(Queue Full)',
    send_msg_dropped_too_large: 'Dropped Messages Out(Message Oversize)',
  ...
  logTrace: {
    ...
    waiting: 'Waiting',
    running: 'Running',
    createLog: 'Create Trace',
    viewLog: 'View Trace',
    createSuc: 'Create Log Trace Successfully',
    stopSuc: 'Stop Log Trace Successfully',
    deleteSuc: 'Delete Log Trace Successfully',
    tooLargeLog: 'The Trace is too long, you better download to view',
    confirmDeleteTrace: 'Confirm to delete this Trace',
    needStartTime: 'start time or end time is required',
    needOnePacket: 'please choose at least one packet',
    loadNextPage: 'Loading More Log',
    srunning: 'Running',
    sstopped: 'Stopped',
    swaiting: 'Waiting',
